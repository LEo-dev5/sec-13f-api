...
# app/main.py (이 함수 전체를 덮어쓰기)

@app.get("/sitemap.xml", include_in_schema=False)
async def sitemap():
    # 🚨 수정: 공백 문제를 막기 위해 한 줄씩 명확하게 작성
    xml = '<?xml version="1.0" encoding="UTF-8"?>\n'
    xml += '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
    xml += '    <url><loc>https://easy13f.com/</loc><changefreq>daily</changefreq><priority>1.0</priority></url>\n'
    xml += '    <url><loc>https://easy13f.com/search</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>\n'
    xml += '</urlset>'
...
app.include_router(stock.router, tags=["Stock Detail"])